...
function addArtist(array, id, name, years, genre, nationality, bio){
  ...
  console.log(addArtist(artists, 30, 'Rafael de Molina', '1989-current day', 'Web Design', 'United States of America', 'The realest on the streets, always cook bon apetit'))
